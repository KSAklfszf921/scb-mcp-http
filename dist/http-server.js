    ...
    try {
        switch (name) {
            ...
            case 'scb_get_table_info':
                const tableInfo = await apiClient.getTableMetadata(args.tableId, args.language || 'en');
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'scb_get_table_data':
                const data = await apiClient.getTableData(args.tableId, args.selection, args.language || 'en');
